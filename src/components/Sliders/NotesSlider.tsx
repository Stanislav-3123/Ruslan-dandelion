...
const NotesSlider = () => {
    ...
    return (
        <div className="sm:hidden sm:w-1/2 overflow-y-hidden sm:overflow-y-visible self-stretch inline-flex">
            {/*<div*/}
            {/*    className="hidden flex-wrap self-stretch h-[320px] justify-start items-start sm:inline-flex">*/}
            ...
            {/*</div>*/}
            <div
                className="sm:hidden overflow-y-hidden self-stretch h-[320px] justify-start items-start inline-flex">
