...
const ImagesSlider = () => {
    ...
    return (
        <div className="overflow-y-hidden">
            <div
                className="hidden overflow-y-hidden self-stretch h-full justify-start items-start sm:inline-flex">
                <div
                    className="flex gap-2 sm:gap-8 px-4 sm:px-8">
                    <div onMouseOver={handleHover} onMouseOut={handleHover}
                        className="flex flex-col sm:w-[260px] hover:w-[552px] duration-300 justify-between p-8 rounded-[30px] bg-cover bg-center h-[480px] w-[300px] bg-[url('/images/image/image2.jpg')]">
                        {isHovered ? null : <div
                        ...
                        <div className="flex flex-col gap-8">
                            <p className="text-white text-base sm:text-xl font-semibold font-['Roboto'] sm:leading-loose leading-relaxed">
                                Experienced team with in gambling software development
                            </p>
                            <span
                                className="text-white text-sm sm:text-base font-normal font-['Roboto'] leading-snu sm:leading-relaxed">We have
