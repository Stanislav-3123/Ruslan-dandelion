...
const Footer = () => {
    return (
        <footer
            ...
            <div className="text-center text-blue-100 sm:text-[110px] text-[32px] font-bold font-['Syncopate'] uppercase">smart
                choice
            </div>
            <div className="sm:justify-end flex text-slate-300 text-sm sm:text-base font-normal font-['Roboto'] sm:leading-relaxed leading-snug">Smart Choise © 2024 All
                rights reserved
            </div>
        </footer>
    );
